...
export default function Templates() {
    return (
        <div className="mx-auto max-w-[900px] text-center">
            <div className="text-2xl text-[#A594FD]">
            ...
            <div className="grid grid-cols-3 gap-4 my-24">
                <div className="flex flex-col gap-4 bg-[#101010] rounded-lg p-8">
                    <div className="pb-4"><Image src="/Logo.png" alt="logo" width={100} height={100} /></div>
            ...
            <div className="max-w-[1000px]">
                <div className="flex gap-4 justify-center my-4">
                    <div className="bg-[#101010] rounded-lg px-4 py-2">
