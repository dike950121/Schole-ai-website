...
export default function NewVisionLearningAI() {
    return (
        ...
        <div style={{ perspective: 1000 }}>
            <motion.div
                className="flex items-center mx-auto sm:max-w-[700px] lg:max-w-[1000px] xl:max-w-[1160px] 2xl:max-w-[1200px] p-8 border outline border-[#333333] outline-[#333333] outline-1 outline-offset-4 mt-24 mb-8 rounded-md"
                style={{
                    rotateX: useTransform(useScroll().scrollY, [0, 1000], [0, 95])
                }}
            >
                <div className="p-4 text-[--color-text] w-1/2">
                    ...
                    <button className="bg-[var(--color-tertiary)] px-4 py-2 rounded-lg mt-8 font-bold transition:bg,text duration-[0.2s] hover:bg-gray-300 text-[var(--color-text)] hover:text-[var(--color-tertiary)]">Schedule a call</button>
                </div>
