...
export default function ExploreOurDynamicLearningFormats() {
    return (
        <div className="flex items-center gap-16 mx-auto my-20 max-w-[1000px]">
            <FadeInSection fadex='right' fadey={"down"} className="py-8 w-1/2">
            ...
            <FadeInSection fadex='left' fadey="down" className="flex flex-col gap-8 px-8 py-16 w-1/2 bg-[var(--color-secondary)] rounded-lg relative group">
