...
export default function GridBoxes() {
    return (
        <>
            <div className="mx-auto max-w-[1000px] bg-[#101010] p-8 rounded-lg transition:transform duration-[0.6s] hover:[transform:scale(1.1)] mb-4">
                <div className="flex items-center flex-col gap-6 w-1/2 text-center p-8">
                    <div className="text-[#A594FD] text-sm">VISUALISE INFO</div>
            ...
            <div className="flex gap-4 mx-auto max-w-[1000px]">
                <div className="flex flex-col gap-4 bg-[#101010] p-8 rounded-lg transition:transform duration-[0.6s] hover:[transform:scale(1.1)]">
                    <div><Image src="/Logo.png" alt="image load is failed." width={100} height={100} /></div>
                    <div className="flex items-center flex-col gap-6 text-center p-left-8">
                        <div className="text-[#A594FD] text-sm">CUSTOMISE</div>
                ...
                <div className="flex flex-col gap-4 bg-[#101010] p-8 rounded-lg transition:transform duration-[0.6s] hover:[transform:scale(1.1)]">
                    <div><Image src="/Logo.png" alt="image load is failed." width={100} height={100} /></div>
                    <div className="flex items-center flex-col gap-6 text-center p-left-8">
                        <div className="text-[#A594FD] text-sm">EMBED</div>
